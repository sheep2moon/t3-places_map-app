...
const PlacesSearch = () => {
    return (
        <form className="ml-auto flex items-center">
            ...
            <button
                type="submit"
                className="ml-2 rounded-lg bg-secondary p-2.5 text-sm font-medium hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-secondary dark:text-primary dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
