    ...
    return (
        <button
            ...
            className={clsx(
                ...
                {
                    "rounded-lg bg-secondary px-5 text-sm font-medium text-dark hover:bg-white focus:outline-none focus:ring-4 focus:ring-secondary dark:focus:ring-secondary": variant === "filled",
