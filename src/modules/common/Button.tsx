    ...
    return (
        <button
            ...
            className={clsx(
                ...
                {
                    "rounded-lg bg-secondary px-5 text-sm font-medium text-dark hover:bg-black focus:outline-none focus:ring-4 focus:ring-secondary dark:focus:ring-secondary": variant === "filled",
                    ...
                    "rounded-lg border border-secondary px-5 py-2.5 text-center text-sm font-medium text-secondary hover:bg-secondary hover:text-dark focus:outline-none focus:ring-4 focus:ring-secondary dark:border-secondary dark:text-secondary dark:hover:bg-secondary  dark:hover:text-dark dark:focus:ring-secondary":
                        variant === "outline",
                    "rounded-md  bg-primary px-3 py-2 text-center text-sm text-secondary shadow-md shadow-dark hover:outline hover:outline-secondary/20": (variant = "minimal")
                },
                className
            )}
        >
