    ...
    return (
        <div className="relative h-52 w-80">
            ...
            <div className="absolute top-4 left-0 flex h-48 w-full">
                ...
                <div className="flex h-full w-full flex-col justify-end rounded-md bg-dark shadow-sm dark:shadow-indigo-800">
                    <div className="relative flex h-12 p-1">
                        ...
                        <button onClick={() => handleGoToPlace(place)} className="ml-auto mr-2">
                            <BsArrowRightSquareFill className="text-3xl dark:text-secondary" />
                        </button>
                    </div>
                </div>
            </div>
