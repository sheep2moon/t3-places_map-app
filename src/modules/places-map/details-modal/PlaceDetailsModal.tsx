    ...
    <>
      <div className="relative h-48 w-full">
        ...
        <div className="absolute bottom-1 left-1">
          {data?.type && <PlaceTypeBadge size="sm" placeType={data.type} />}
        </div>
      ...
      <div className="mx-1 mt-1 grid grid-cols-2 gap-1">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-sm border-2 border-indigo-900  px-2 py-1 dark:bg-dark"
        >
          <Image
            src={mapMarkerIcon}
      ...
      <div className="px-2">
        ...
        <div className="flex flex-col text-xs">
          <pre className="whitespace-pre-wrap text-left font-mono text-lg">
            {data?.description}
          </pre>
        </div>
