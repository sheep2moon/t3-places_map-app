            ...
            <div className="fixed right-0 top-16 bottom-0  shadow-md shadow-black/50">
              <div className="flex h-[calc(100vh_-_4rem)] items-center justify-center overflow-y-scroll text-center">
                <Transition.Child
                  ...
                  leaveTo="opacity-0"
                >
                  <Dialog.Panel className="relative h-full w-screen transform bg-light align-middle shadow-xl transition-all md:max-w-[480px]">
                    <button
                      onClick={closeModal}
...
const ModalContent = ({ data }: ModalContentProps) => {
  ...
  return (
    <>
      ...
      <div className="z-10 rounded-t-3xl border-t-2 border-light/20 bg-primary">
